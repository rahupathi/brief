...
public class CollectionDAL extends DBBaseAdapter {

	private static final String TAG = "CollectionDAL";
	private static final String KEY_ROWID = "ReceiptId";
	private static final String DATABASE_TABLE = "Receipts";
	private static final String TABLE_SELECT = "Select ReceiptId,Lineid, CollectionDate, MemberId, Notes, Amount, TypeId, CollectedBy from Receipts";
	

	public CollectionDAL(Context context) {
		super(context);
	}
	...
	public ArrayList<TLine> GetCollectinLineByLineIdAndDate(String sDate, Integer LineId) {
